...
<%@page import="org.w3c.dom.html.HTMLTitleElement"%>
...
<% 
   ...
   //업로드된 파일의 폴더 경로
   String realFolder = "C:/green_project/jspworks/chap01/src/main/webapp/upload";

   //MultipartRequest 객체 생성
   MultipartRequest multi = new MultipartRequest(request, realFolder,
         5*1024*1024, "utf-8", new DefaultFileRenamePolicy());

   //요청 파마리터 name 속성 처리(Enumeration 클래스 사용)
   ...
   while(files.hasMoreElements()){
	 ...
	 String fileName = multi.getFilesystemName(name); // 서버에 업로드할 파일이름
